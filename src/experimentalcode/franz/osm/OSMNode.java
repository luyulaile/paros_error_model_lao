...
public class OSMNode<L extends OSMLink> extends Node<L> implements Serializable{
    ...
    transient private HashMap<String, String> attr = null;
    ...
    /**
     * returns the link to the darget node or null if no such link exists.
